...
package local_project.load_countries_0_1;
 ...
 * @status
 */
public class load_countries implements TalendJob {
	...
	private final String jobName = "load_countries";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					load_countries.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(load_countries.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fUg3nYUq9eAIqIaDFyGYVp14No0NOjvE2J0FtrRwsXzTa/Zf");
				...
				query_tDBRow_1 = "drop table if exists public.countries cascade; ";
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_load_countries = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_load_countries = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_load_countries.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_load_countries.length == 0) {
						commonByteArray_LOCAL_PROJECT_load_countries = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_load_countries = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_load_countries, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_load_countries, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_load_countries) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("countries");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("countries");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LUu5hHVWCN+9L4M8xHAORGtFLHETUxwXQrVw75/TYUbL/Xmg");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("countries")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"COUNTRY_ID\" VARCHAR(2)  ,\"COUNTRY_NAME\" VARCHAR(24)  ,\"REGION_ID\" INT4 ,primary key(\"COUNTRY_ID\"))");
					}
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/Users/tim/Desktop/data/countries_file.txt";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/Users/tim/Desktop/data/countries_file.txt", "US-ASCII", "|", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.REGION_ID = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"REGION_ID", "row1", temp, ex_tFileInputDelimited_1),
...
// # Output table : 'out1'
								...
								out1_tmp.COUNTRY_NAME = row1.COUNTRY_NAME;
								out1_tmp.REGION_ID = row1.REGION_ID;
								out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.COUNTRY_ID == null) {
									...
									pstmt_tDBOutput_1.setString(1, out1.COUNTRY_ID);
								}

								if (out1.COUNTRY_NAME == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, out1.COUNTRY_NAME);
								}

								if (out1.REGION_ID == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(3, out1.REGION_ID);
								}
					...
					if (!((Object) ("/Users/tim/Desktop/data/countries_file.txt") instanceof java.io.InputStream)) {
...
// ###############################      
	...
	public static void main(String[] args) {
		final load_countries load_countriesClass = new load_countries();

		int exitCode = load_countriesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_countries.class.getClassLoader()
					.getResourceAsStream("local_project/load_countries_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = load_countries.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : load_countries");
		}
...
/************************************************************************************************
 * 60485 characters generated by Talend Open Studio for Big Data on the March
 * 15, 2021 10:57:02 PM EDT
 ************************************************************************************************/