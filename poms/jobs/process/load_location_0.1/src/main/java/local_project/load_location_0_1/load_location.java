...
package local_project.load_location_0_1;
 ...
 * @status
 */
public class load_location implements TalendJob {
	...
	private final String jobName = "load_location";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					load_location.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(load_location.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBRow_1 = "jdbc:postgresql://" + "loki.cljnvgc6t1vp.us-east-2.rds.amazonaws.com" + ":"
						+ "5432" + "/" + "postgres";
				...
				final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Uo3dHs1uYSPs3v4tESiBM+KN4eq6JIAMBQzOOHl1clrCFsQv");
				...
				query_tDBRow_1 = "drop table if exists locations cascade; ";
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_load_location = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_load_location = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_load_location.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_load_location.length == 0) {
						commonByteArray_LOCAL_PROJECT_load_location = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_load_location = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_load_location, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_load_location, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_load_location) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("locations");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("locations");
				}
				...
				String url_tDBOutput_1 = "jdbc:postgresql://" + "loki.cljnvgc6t1vp.us-east-2.rds.amazonaws.com" + ":"
						+ "5432" + "/" + "postgres";
				dbUser_tDBOutput_1 = "postgres";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XS7Wy+Ttk01UmVEzgge0XIryeF7BTIF/0RQppfO8qVo55ko4");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("locations")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"LOCATION_ID\" INT4 ,\"STREET_ADDRESS\" VARCHAR(40)  ,\"POSTAL_CODE\" VARCHAR(11)  ,\"CITY\" VARCHAR(19)  ,\"STATE_PROVINCE\" VARCHAR(17)  ,\"COUNTRY_ID\" VARCHAR(2)  ,primary key(\"LOCATION_ID\",\"COUNTRY_ID\"))");
					}
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/Users/tim/Desktop/data/locations_file.txt";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/Users/tim/Desktop/data/locations_file.txt", "US-ASCII", "|", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.LOCATION_ID = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"LOCATION_ID", "row1", temp, ex_tFileInputDelimited_1),
							...
							row1.STREET_ADDRESS = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.STATE_PROVINCE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'out1'
								out1_tmp.LOCATION_ID = row1.LOCATION_ID;
								out1_tmp.STREET_ADDRESS = row1.STREET_ADDRESS;
								out1_tmp.POSTAL_CODE = row1.POSTAL_CODE;
								out1_tmp.CITY = row1.CITY;
								out1_tmp.STATE_PROVINCE = row1.STATE_PROVINCE;
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.LOCATION_ID == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(1, out1.LOCATION_ID);
								}

								if (out1.STREET_ADDRESS == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, out1.STREET_ADDRESS);
								}

								if (out1.POSTAL_CODE == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, out1.POSTAL_CODE);
								}

								if (out1.CITY == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, out1.CITY);
								}

								if (out1.STATE_PROVINCE == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, out1.STATE_PROVINCE);
								}

								if (out1.COUNTRY_ID == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, out1.COUNTRY_ID);
								}
					...
					if (!((Object) ("/Users/tim/Desktop/data/locations_file.txt") instanceof java.io.InputStream)) {
...
// ###############################      
	...
	public static void main(String[] args) {
		final load_location load_locationClass = new load_location();

		int exitCode = load_locationClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_location.class.getClassLoader()
					.getResourceAsStream("local_project/load_location_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = load_location.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : load_location");
		}
...
/************************************************************************************************
 * 64016 characters generated by Talend Open Studio for Big Data on the March
 * 15, 2021 11:02:54 PM EDT
 ************************************************************************************************/